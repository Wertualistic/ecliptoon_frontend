      ...
      <div className="space-y-6 animate-pulse">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="h-28 bg-slate-900/60 rounded-2xl border border-white/5"></div>
          ))}
        </div>
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          ecliptoon platformasining bugungi moliyaviy va foydalanuvchilar
          faolligi statistikasi
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-5 rounded-2xl border border-white/5 space-y-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-emerald-400 font-semibold mt-1">
              Bugun tasdiqlangan o'tkazmalar
            </p>
          </div>
        </div>
        ...
        <Link
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-semibold mt-1">
              Tasdiqlanishi kerak bo'lgan kvitansiyalar
            </p>
          </div>
        </Link>
        ...
        <Link
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-semibold mt-1">
              Ro'yxatdan o'tgan jami a'zolar
            </p>
          </div>
        </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 glass-card p-6 rounded-2xl border border-white/5 space-y-4 text-slate-300">
          ...
          <p className="text-xs leading-relaxed">
            Platformaning to'lov tizimi to'liq **manual bank o'tkazmalari**ga
            asoslangan.
          </p>
          <p className="text-xs leading-relaxed">
            Qabul qilingan har bir arizadagi to'lov kvitansiyasini (screenshot)
            diqqat bilan solishtiring, karta raqami va tushgan pul miqdorini
            banking ilovangiz orqali tekshiring.
          </p>
          <div className="bg-red-500/5 border border-red-500/10 p-3 rounded-lg text-[10px] text-red-300">
            ⚠️ **MUHIM**: Rad etilgan arizalar uchun rad etish sababini aniq
            ko'rsating, chunki foydalanuvchi buni o'z kabinetida ko'radi.
          </div>
        </div>
      </div>
    </div>
